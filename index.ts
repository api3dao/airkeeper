  ...
  chains
    ...
    .forEach(async (chain: node.ChainConfig) => {
      each(chain.providers, async (_, providerName) => {
        ...
        // TODO: where should this come from? config file?
        const rrpBeaconServerAddress =
        ...
        // 4. Make API request
        // **************************************************************************
        const endpoint = config.ois[0].endpoints[0];
        ...
        const sponsorWalletAddress =
          "0x2f492fA825f351427315378e8449a7A4D2a2565d";
