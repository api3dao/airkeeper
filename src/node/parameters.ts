...
export function getReservedParameterValue(
  ...
  const reservedParameter = endpoint.reservedParameters.find(
    (rp) => rp.name === name
  );
...
export function getReservedParameters(
  endpoint: Endpoint,
  requestParameters: ApiCallParameters
) {
  const _path = getReservedParameterValue(
    ReservedParameterName.Path,
    endpoint,
    requestParameters
  );
  const _times = getReservedParameterValue(
    ReservedParameterName.Times,
    endpoint,
    requestParameters
  );
  const _type = getReservedParameterValue(
    ReservedParameterName.Type,
    endpoint,
    requestParameters
  );
  const _relay_metadata = getReservedParameterValue(
    ReservedParameterName.RelayMetadata,
    endpoint,
    requestParameters
  );
